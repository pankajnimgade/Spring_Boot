...
import university.application.spring.database.domain.Course;
...
import university.application.spring.database.repo.DepartmentRepository;
import university.application.spring.database.repo.StaffRepository;
import university.application.spring.database.repo.StudentRepository;
...
public class QueryDemos {
    ...
    public void jpqlQueries() {
        ...
        //Select new university.application.spring.database.view.CourseView
    ...
    public void pagingAndSortingQueries() {
        ...
        System.out.println("\nFiCourseViewnd all staff members, sort alphabetically by last name");
